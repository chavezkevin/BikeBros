document.addEventListener('DOMContentLoaded', () => {
    ...
    const baseDeDatos = [
        ...
        {
            id: 3,
            nombre: 'BICICLETA CROSSBOY-R12',
            precio: 24.915,
            imagen: './img/img-KIDS/crossboyR12.png',
            descripcion: 'para los mas chiquitos, lista para soportar toda la energia.'
        },
        {
            id: 4,
    ...
    */
    function renderizarProductos() {
        baseDeDatos.forEach((info) => {
            ...
            miNodo.classList.add('card', 'col-sm-5', 'm-1');
            // Body
